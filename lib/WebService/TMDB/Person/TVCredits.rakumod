use WebService::TMDB::Person::TVCast;
use WebService::TMDB::Person::TVCrew;

unit class WebService::TMDB::Person::TVCredits;

has WebService::TMDB::Person::TVCast @.cast;
has WebService::TMDB::Person::TVCrew @.crew;
has Int $.id;
