use WebService::TMDB::Person::MovieCast;
use WebService::TMDB::Person::MovieCrew;

unit class WebService::TMDB::Person::MovieCredits;

has WebService::TMDB::Person::MovieCast @.cast;
has WebService::TMDB::Person::MovieCrew @.crew;
has Int $.id;
